...
KEYWORDS = ['дизайн', 'фото', 'web', 'python', '2025', '2024', 'библиотека', 'chatGPT', 'победили']
...
for article in articles:
    article_link = ('https://habr.com' +
                    article.find('a', class_='tm-article-datetime-published_link')['href'])
    ...
    contains_keyword_from_title = any(keyword_ in article_title for keyword_ in KEYWORDS)
    ...
    contains_keyword_from_text = any(keyword_ in article_text for keyword_ in KEYWORDS)
